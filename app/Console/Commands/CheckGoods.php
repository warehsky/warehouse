...
class CheckGoods extends Command
{
     ...
     * @var string
     */
    protected $signature = 'goods:check';
     ...
     * @var string
     */
    protected $description = 'Проверка привязки тегов для акционных товаров';
    ...
    {
        $sql = "INSERT INTO `itemTags`(`itemId`, `tagId`, `moderatorId`) select pt.itemId, 330, 1 from mtagent.prices as pt inner join mtShop.itemsLink as l on pt.itemId=l.id where pt.priceType=16 and pt.areaId = 1 and !EXISTS(SELECT * from mtShop.itemTags as it WHERE it.itemId=pt.itemId and it.tagId=330)";
    }
    /*
