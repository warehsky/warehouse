    ...
    ArrowOverlay.prototype = extend(ArrowOverlay.prototype, {
        ...
        _createArrowContours: function () {
            ...
            if (arrowLength > 0) {
                ...
                for(n=mainLineCoordinates.length-1; n>0; n--){
                var lastTwoCoordinates = [
                        mainLineCoordinates[mainLineCoordinates.length - n-1],
                        mainLineCoordinates[mainLineCoordinates.length - n]
                    ],
                ...
                // а потом развернем результаты обратно.
                    ...
                    arrowAngle = this.options.get('arrowAngle', 10) / 180 * Math.PI,
